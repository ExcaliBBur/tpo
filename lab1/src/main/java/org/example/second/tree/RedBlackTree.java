...
public class RedBlackTree {
    ...
    public String preorderTraversal() {
        ...
        return preorderTraversal(header.rightChild, stringBuilder);
    }

    private String preorderTraversal(RedBlackNode node, StringBuilder stringBuilder) {
        if (node != nullNode) {
            char c = 'R';
            if (node.color == 1)
                c = 'B';
            stringBuilder.append(node.element).append(c).append(" ");
            preorderTraversal(node.leftChild, stringBuilder);
            preorderTraversal(node.rightChild, stringBuilder);
        }
    ...
    public String inorderTraversal() {
        StringBuilder stringBuilder = new StringBuilder();
        return inorderTraversal(header.rightChild, stringBuilder);
    }

    private String inorderTraversal(RedBlackNode node, StringBuilder stringBuilder) {
        if (node != nullNode) {
            inorderTraversal(node.leftChild, stringBuilder);
            char c = 'R';
            if (node.color == 1)
                c = 'B';
            stringBuilder.append(node.element).append(c).append(" ");
            inorderTraversal(node.rightChild, stringBuilder);
        }
        return stringBuilder.toString();
    }
    ...
    public String postorderTraversal() {
        StringBuilder stringBuilder = new StringBuilder();
        return postorderTraversal(header.rightChild, stringBuilder);
    }

    private String postorderTraversal(RedBlackNode node, StringBuilder stringBuilder) {
        if (node != nullNode) {
            postorderTraversal(node.leftChild, stringBuilder);
            postorderTraversal(node.rightChild, stringBuilder);
            char c = 'R';
            if (node.color == 1)
                c = 'B';
            stringBuilder.append(node.element).append(c).append(" ");
